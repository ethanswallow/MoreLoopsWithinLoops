...
def run_test_largest_number():
    ...
    # Test 4:
    expected = 50
    answer = largest_number([(0, 50, 2, 8),
                             (13, 10, 11, 7, 10),
                             [1, 2, 3, 4]])
    print('Expected and actual are:', expected, answer)
...
def run_test_largest_negative_number():
    ...
    # Test 3:
    expected = -4
    answer = largest_negative_number([(-30, 1, -4),
                             (13, -10, 11, 7, -10),
                             [1, -20, 3, 4]])
    print('Expected and actual are:', expected, answer)
...
def first_is_elsewhere_too(seq_seq):
    ...
    for k in range(len(seq_seq[0])):
        for m in range(len(seq_seq) - 1):
            for n in range(len(seq_seq[m + 1])):
                if seq_seq[0][k] == seq_seq[m + 1][n]:
                    return True
